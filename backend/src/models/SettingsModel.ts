...
const SETTING_DESCRIPTIONS: Record<string, string> = {
  ...
  helpHighlightsTitle: "Título da seção de destaques da página Ajuda",
  helpHighlightsItems: "Itens em destaque da página Ajuda",
...
class SettingsModel {
  ...
  private static readonly PUBLIC_KEYS = [
    ...
    "showCompanyTradeNameHeader", "showCompanyTradeNameFooter", "showCompanySloganFooter",
    ...
    "helpHighlightsTitle", "helpHighlightsItems",
