        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="py-4">
            <p className="text-sm text-foreground">
              <strong>Vídeo de capa (principal):</strong> ordem <Badge variant="outline">0</Badge> — exibido no catálogo (capa do card) e na área da imagem na página do modelo. •{" "}
              <strong>Vídeo tutorial:</strong> ordem <Badge variant="outline">1</Badge> — exibido como &quot;Assistir Vídeo Tutorial&quot; na página do modelo. •{" "}
              <strong>Extra:</strong> ordem 2+ — listados na seção Vídeos Tutoriais. Use os botões ↑ ↓ na tabela para reordenar.
            </p>
          </CardContent>
        </Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  0 = Capa (catálogo e imagem) • 1 = Tutorial • 2+ = Extra
                </p>
              </div>
