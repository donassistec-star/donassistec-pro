...
const HomeContentAdmin = () => {
  ...
  const handleHeroChange = async (
    field: "heroTitle" | "heroSubtitle" | "heroCtaLabel" | "heroSecondaryCtaLabel" | "heroBadge" | "heroImage" | "heroCtaLink",
    value: string
  ) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">
                  URL da Imagem do Hero (opcional)
                </label>
                <Input
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleHeroChange("heroCtaLink", e.target.value as any)}
